...
include("php/checklogin.php");
 ?>
                ...
                <div class="container-fluid">
                      ...
                      <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Track your Attandence</h1>
                    <p class="mb-4">Here you can track your attandence. </p>
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo '<div class="alert alert-warning alert-dismissible fade show" role="alert"><i class="fas fa-exclamation-triangle"></i>
                Sorry! No record found. Please add request under any of Mibcs database</a>
